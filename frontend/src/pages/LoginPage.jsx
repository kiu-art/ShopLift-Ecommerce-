    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="relative w-full max-w-md backdrop-blur-2xl bg-white/[0.02] border border-white/[0.05] shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] rounded-3xl p-8 sm:p-10 z-10">
        ...
        <div className="mb-10 text-center">
          ...
          <h2 className="text-3xl font-semibold text-white tracking-tight mb-2">Welcome User,</h2>
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link to={"/register"} className="text-white font-medium hover:underline hover:text-gray-200 transition-colors">
            Sign up now
          </Link>
        </p>
